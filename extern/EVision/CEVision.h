...
public:
        ...
        void __fastcall LoadTool(char *strFileName,AnsiString strSch,bool bFileType=true);     //false: old tyoe true: new tyoe
        ...
        double __fastcall GetMatchPosX(int nIndex=0);
        double __fastcall GetMatchPosY(int nIndex=0);
        double __fastcall GetMatchScore(int nIndex=0);
        double __fastcall GetMatchPosX(EMatch &theMatch,int nROI,int nIndex=0);
        double __fastcall GetMatchPosY(EMatch &theMatch,int nROI,int nIndex=0);
        ...
        void __fastcall DrawAll(HDC hDC);
