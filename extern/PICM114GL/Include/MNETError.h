...
#define ERR_G94_InvalidParameter        -38
#define ERR_G94_MsgCommunication        -39
#define ERR_G94_MsgSize					-40
...
#define ERR_AI8_OutOfMeasureRange			-122
...
#define ERR_DataFifoFull					   -188
#define ERR_DataCommunicationFailed			   -189
...
#define ERR_M204_PChangeSlowDownPointError	-221
#define ERR_M204_DChangeSlowDownPointError	-222
#define ERR_M204_NotSetContinuousMove		-223
#define ERR_M204_NotSetContinuousMoveOn		-224
//========PCI-8601 device ==============================
...
//======PCI-M114GL Device ===============================
#define ERR_M114GL_Base                       (-360)
#define ERR_M114GL_FailToSetComSpeed          (ERR_M114GL_Base-1)

//======Motion Connecter Device (G9103A)===============================
#define ERR_MMC_Base                        (-400)
#define ERR_InvalidSpeedPattern             (ERR_MMC_Base-1)
#define ERR_InvalidParameter				(ERR_MMC_Base-2)
#define ERR_M1A_InvalidCheckCode			(ERR_MMC_Base-3)
#define ERR_M1A_AxisArrayError				(ERR_MMC_Base-4)
